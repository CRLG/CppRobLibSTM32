...
VL53L0X_Error VL53L0xMultiBase::_init()
{
    ...
    for (int i=get_vl53_count()-1; i>=0; i--) {  // initialise dans l'ordre inverse car la table des @I2C commence généralement par l'adresse par défaut 0x52 qui doit être la dernière à programmer
